...
- Review the stacked `canon-skill` Day 1 and Day 2 draft changes after validation. Then implement Day 3 validation/recovery contracts: V1/V2/V3 validators, strict result classification, one-safe-retry `HARD_RESET`, non-automatic `RETRY_REQUIRED`, `REFINE_ELIGIBLE`, clean-master provenance, and continuity admission/rejection tests.
